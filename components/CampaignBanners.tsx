          ...
          <div className="flex gap-2 sm:gap-2.5 md:gap-3 pb-2" style={{ minWidth: 'max-content' }}>
            {campaigns.map((campaign, index) => (
              <Link
                key={index}
                href={campaign.link}
                className="flex-shrink-0 bg-white border border-gray-300 rounded-lg px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2.5 lg:py-3 hover:shadow-md hover:border-green-500 hover:bg-green-50 transition-all whitespace-nowrap"
              >
