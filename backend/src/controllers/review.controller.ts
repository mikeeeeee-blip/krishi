...
export class ReviewController {
  ...
  updateReview = asyncHandler(async (req: Request, res: Response) => {
    ...
    const review: any = await Review.findOneAndUpdate(
  ...
  deleteReview = asyncHandler(async (req: Request, res: Response) => {
    ...
    const review: any = await Review.findOneAndDelete(query);
  ...
  markHelpful = asyncHandler(async (req: Request, res: Response) => {
    ...
    const review: any = await Review.findByIdAndUpdate(id, update, { new: true });
  ...
  approveReview = asyncHandler(async (req: Request, res: Response) => {
    const review: any = await Review.findByIdAndUpdate(
      req.params.id,
      { isApproved: true },
      { new: true }
    );
